                                  ...
                                  <tbody id="myData">
                                    ...
                                    <?php $no=1; foreach ($tanggal_radar as $row2) {
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <a href="cetak_data_radar?tanggal=<?php  echo $row2->tanggal; ?>" target="_blank"><span class="btn btn-default small glyphicon glyphicon-print" style="color: white;background-color: #FF0000; margin: 5px;"> Print</span></a>    
